...
class Ui_MainWindow(QObject):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(10, 20, 371, 95))
        ...
        self.horizontalLayout_3.setContentsMargins(140, -1, 140, -1)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(40, 20, 304, 251))
        ...
        self.pushButton_3.clicked.connect(self.prevImageSlot)
        self.pushButton_4.clicked.connect(self.nextImageSlot)
        self.horizontalSlider.sliderMoved.connect(self.imageSliderMovedSlot)

        self.pushButton_5.clicked.connect(self.loadModelSlot)
        self.pushButton_6.clicked.connect(self.deleteModelSlot)
        self.listWidget.currentItemChanged.connect(self.listSelectSlot)
        self.horizontalSlider_3.sliderMoved.connect(self.alphaSliderMovedSlot)

        self.pushButton_7.clicked.connect(self.exportSlot)
        self.pushButton_20.clicked.connect(self.editItemSlot)

        self.pushButton_8.pressed.connect(self.transXNSlot)
        self.pushButton_9.pressed.connect(self.transXPSlot)
        self.pushButton_10.pressed.connect(self.transYNSlot)
        self.pushButton_11.pressed.connect(self.transYPSlot)
        self.pushButton_12.pressed.connect(self.transZNSlot)
        self.pushButton_13.pressed.connect(self.transZPSlot)

        self.pushButton_14.pressed.connect(self.rotRNSlot)
        self.pushButton_15.pressed.connect(self.rotRPSlot)
        self.pushButton_16.pressed.connect(self.rotPNSlot)
        self.pushButton_17.pressed.connect(self.rotPPSlot)
        self.pushButton_18.pressed.connect(self.rotYNSlot)
        self.pushButton_19.pressed.connect(self.rotYPSlot)

        self.lineEdit_3.editingFinished.connect(self.poseSlot)
        self.lineEdit_4.editingFinished.connect(self.poseSlot)
        self.lineEdit_5.editingFinished.connect(self.poseSlot)
        self.lineEdit_6.editingFinished.connect(self.poseSlot)
        self.lineEdit_7.editingFinished.connect(self.poseSlot)
        self.lineEdit_8.editingFinished.connect(self.poseSlot)
